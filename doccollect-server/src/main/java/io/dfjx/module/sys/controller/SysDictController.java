...
public class SysDictController {
    ...
    public R types(){
        List<Map<String, Object>> lst = sysDictService.types();
        return R.ok().put("list", lst);
    }

    @RequestMapping("/values")
    public R values(@RequestParam String type){
        List<Map<String, Object>> lst = sysDictService.values(type);
        return R.ok().put("list", lst);
    }
}

package io.dfjx.module.auth.service.impl;
...
public class AuthServiceImpl implements AuthService {
    ...
    @Value("${auth-frontier-url}")
    private String authFrontierUrl;
...
//            refreshTokenCookie.setDomain(tokenDomain);
    ...
    public Set<String> selectPermissionsByUserIdAndSystemToSet(Long userId){
        ...
        String reqUrl = authUrl + UrlEnum.selectPermissionsByUserIdAndSystem.getUrl() + "?userId="+ userId +"&appName=" + Constant.APP_NAME;
    ...
    public Boolean checkLogin(HttpServletRequest request) {
        ...
        if(isAuth && StringUtils.isBlank(token)){
            return false;
        }
        return true;
    }

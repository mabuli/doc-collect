...
@TableName("org_exchange_sum_d")
public class OrgExchangeSumD implements Serializable {
	...
	public static ShareOrganTop5Vo ofShareOrganTop5Vo(OrgExchangeSumD model) {
